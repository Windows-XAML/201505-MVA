...
namespace Template10.ViewModels
{
    public class MainPageViewModel : Mvvm.ViewModelBase
    {
        ...
        public bool ShowAds { get { return _ShowAds; } set { Set(ref _ShowAds, value); } }

        private Command _RemoveAdsCommand;
        public Command RemoveAdsCommand
        {
            get
            {
                return _RemoveAdsCommand ?? (_RemoveAdsCommand = new Command(
                  async () =>
                  {
                      var service = new Services.InAppPurchaseService.InAppPurchaseService("AdFree");
                      await service.Setup();
